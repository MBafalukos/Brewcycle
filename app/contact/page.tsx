          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <section className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                >
                  ...
                  <span className="font-medium">Brewcycle</span> meine
                  übermittelten Daten speichert, sodass meine Anfrage
            ...
            <div className="pt-2">
              <Button
                type="submit"
                disabled={!canSubmit}
                className="h-11 rounded-xl bg-[#1F6F50] px-6 text-white hover:opacity-90"
              >
              ...
              {!consent ? (
                <p className="mt-3 text-xs text-muted-foreground">
                  Bitte bestätige die Einwilligung, um das Formular abzusenden.
                </p>
              ) : null}
            </div>
          </form>
