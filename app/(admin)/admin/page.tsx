...
export default function AdminDashboardPage() {
  const [stats, setStats] = useState({ surveys: 0, waitlist: 0, buttonClicks: 0 });
  ...
  const interestData = Object.entries(analytics["interest_reason"] || {}).map(([key, value]) => ({
    name:
      key === "sustainability"
        ? "Nachhaltigkeit"
        : key === "vegan"
  ...
  const purchaseChannelData = Object.entries(analytics["typical_purchase_channel"] || {}).map(
    ([key, value]) => ({
      name:
        key === "online_shop"
          ? "Online-Shop"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">High-level metrics and survey responses.</p>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-3">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">Learn more interactions</p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card className="col-span-1">
          <CardHeader>
            ...
            <CardDescription>Primary reason for interest in Brewcycle</CardDescription>
          </CardHeader>
        ...
        <Card className="col-span-1">
          <CardHeader>
            ...
            <CardDescription>Where users usually buy garden supplies</CardDescription>
          </CardHeader>
          <CardContent className="h-[300px]">
